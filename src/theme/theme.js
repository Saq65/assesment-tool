...
export const DarkSpacesTheme = createTheme({
  ...
  components: {
    MuiSnackbar: {
      styleOverrides: {
        root: {
          // Default background for Snackbar (if needed for general use)
        },
      },
    },
    MuiAlert: {
      styleOverrides: {
        // Success severity
        filledSuccess: {
          backgroundColor: "#E0FCE0", // Light green background for success
          color: "#1B801B", // Title text color
        },
        // Error severity
        filledError: {
          backgroundColor: "#F8D7DA", // Light red background for error
          color: "#721C24", // Title text color
        },
        // Info severity
        filledInfo: {
        ...
        filledWarning: {
          ...
          color: "#856404", // Title text color
        },
        // Custom description color within the Alert component
        // message: {
        //     color: '#1B801B', // Default text color for message inside alert
        // },
      },
    },
    ...
    MuiOutlinedInput: {
      styleOverrides: {
        root: {
          // Adjust padding for input adornment
          ...
          "&.Mui-error .MuiOutlinedInput-notchedOutline": {
            borderColor: "#FF1943", // Red color for error
          },
          // Hover in error state
    ...
    MuiInputLabel: {
      styleOverrides: {
        root: {
          color: "#ffffff6", // Default label color
          "&.Mui-focused": {
            color: "#ffffff", // Focused label color
          },
          "&.Mui-error": {
            color: "red", // Ensure no red when there's no error
          },
        },
      },
    },
      ...
      styleOverrides: {
        root: {
          "&:hover .MuiCheckbox-root, &:hover .MuiRadio-root": {
            color: "#7DD3FC", // Hover effect on checkbox/radio when label is hovered
            backgroundColor: "rgba(125, 211, 252, 0.1)", // Hover background color
          },
        },
        label: {
          color: '#ffffff',
